    ...
    <nav className="bg-white fixed z-20 top-0 w-full start-0 border-b border-gray-300 px-4 md:px-12">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-1 ">
        <Link href="/" className="flex items-center space-x-3">
          <Image src="/cutlogo.png" alt="logo" width={110} height={50} />
        </Link>
        ...
        <div className="md:flex items-center justify-between hidden w-full md:w-auto md:order-1">
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 md:flex-row md:mt-0 md:border-0">
            <li>
              <Link href="/Services" className="block py-2 px-3  text-white bg-green-700 rounded md:bg-transparent md:text-green-700 md:p-0 ">
                Services
              </Link>
            </li>
            <li>
